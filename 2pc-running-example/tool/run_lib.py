...
global fault_handler_map
fault_handler_map = { 
	"ML" : "< ml : MsgLoss | ",
	"MD" : "< msgdup : MsgDup | dupMsg: nilSL, ",
	"PT" : "< pt : Partition | status: healthy, ",
	"CR" : "< cr : Crash | nodeStatus: normal, ",
	"DL" : "< dl : Delay | delayedMSg: nilSL, ",
	"EC" : "< ec : Equivocation | ",
	"TP" : "< tp : Tampering | "}

global INIT_STATE_EQ
INIT_STATE_EQ = ["eq initconf", "eq initConf","eq initstate"]
